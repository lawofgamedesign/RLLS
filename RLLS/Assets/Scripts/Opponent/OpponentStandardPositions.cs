...
public class OpponentStances
{
    ...
    public enum Stances { High, Left, Right, High_Left, High_Right }
    ...
    public void EstablishStances()
    {
        ...
        Quaternion leftRot = Quaternion.Euler(new Vector3(90.0f, 0.0f, 0.0f));
        Quaternion rightRot = Quaternion.Euler(new Vector3(-90.0f, 0.0f, 0.0f));
        Quaternion highLeftRot = Quaternion.Euler(new Vector3(45.0f, 0.0f, 0.0f));
        Quaternion highRightRot = Quaternion.Euler(new Vector3(-45.0f, 0.0f, 0.0f));
